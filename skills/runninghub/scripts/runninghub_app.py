#!/usr/bin/env python3
"""
RunningHub AI Application client for any AI coding agent.
...
from runninghub import resolve_api_key, require_api_key, cmd_check, poll_task, fix_mov_to_mp4, default_output_dir  # noqa: E402
...
def main():
    parser = argparse.ArgumentParser(
        description="RunningHub AI Application client for any AI coding agent",
