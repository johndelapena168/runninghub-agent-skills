#!/usr/bin/env python3
"""
RunningHub universal API client for any AI coding agent.
...
def default_output_dir() -> Path:
    """Cross-platform default output dir (used only when -o is not provided)."""
    return Path(tempfile.gettempdir()) / "rh-output"
...
def require_api_key(provided_key: str | None) -> str:
    ...
    result = {
        ...
        "steps": [
            ...
            "4. Set the RUNNINGHUB_API_KEY environment variable, or pass --api-key",
        ],
    }
...
def main():
    parser = argparse.ArgumentParser(
        description="RunningHub universal API client for any AI coding agent",
